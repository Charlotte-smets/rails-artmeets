...
artist1 = Artist.new(first_name: "Martin", last_name: "Depalle", artist_name: "Martin De Palle", address: "London", description: "French painting artist from Les beaux Arts of Paris. Travelling a lot. I mostly do paintings on oil.")
